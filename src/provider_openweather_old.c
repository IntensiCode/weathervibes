...
// Map OpenWeather condition ID to our standardized enum
static WeatherCondition map_openweather_condition(int weather_id, const char* icon_code) {
    ...
    if (weather_id >= 200 && weather_id < 300) {
        if (weather_id >= 200 && weather_id <= 202) {
    ...
    // Group 5xx: Rain
        ...
        if (weather_id == 500 || weather_id == 520) {
            return WEATHER_CONDITION_LIGHT_RAIN;
        } else if (weather_id == 502 || weather_id == 503 || weather_id == 504 || weather_id == 522) {
            ...
            return WEATHER_CONDITION_SLEET;  // Freezing rain
        }
        return WEATHER_CONDITION_RAIN;
    }
    // Group 6xx: Snow
    else if (weather_id >= 600 && weather_id < 700) {
        if (weather_id == 600 || weather_id == 620) {
    ...
    // Group 7xx: Atmosphere
        ...
        if (weather_id == 701 || weather_id == 721) {
            return WEATHER_CONDITION_MIST;
        } else if (weather_id == 711) {
            return WEATHER_CONDITION_SMOKE;
        } else if (weather_id == 731 || weather_id == 761) {
            return WEATHER_CONDITION_DUST;
        } else if (weather_id == 741) {
            return WEATHER_CONDITION_FOG;
        } else if (weather_id == 751) {
            return WEATHER_CONDITION_SAND;
        } else if (weather_id == 762) {
            return WEATHER_CONDITION_DUST;  // Volcanic ash
        } else if (weather_id == 771) {
            return WEATHER_CONDITION_THUNDERSTORM;  // Squalls
        } else if (weather_id == 781) {
            return WEATHER_CONDITION_TORNADO;
        }
    ...
    *data = weather_data_new();
    ...
    if (json_object_has_member(root_obj, "weather")) {
        ...
        if (json_array_get_length(weather_array) > 0) {
            ...
            // Set the enum - the applet will handle icon mapping
